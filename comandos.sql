...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-07-2022 a las 02:03:39
...
--
-- Base de datos: `virtualllantas`
--

-- --------------------------------------------------------
CREATE DATABASE `virtualllantas`;
--
...
--
-- Estructura de tabla para la tabla `tblpost`
--
...
--
-- Volcado de datos para la tabla `tblpost`
--

INSERT INTO `tblpost` (`IDPOST`, `TITULOPOST`, `EMAIL`, `DESCRIPCION`, `FECHACRE`, `urlImagen`) VALUES
(1, 'Avengers', 'emmanuel302001@gmail.com', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', '2022-07-28 14:56:00', 'imagenes/1_106090984_2e39b218-c369-452e-b5be-d2476f9d8728.jpg'),
(2, 'Batman', 'emmanuel302001@gmail.com', 'Batman es un personaje de cómic creado por los estadounidenses Bob Kane y Bill Finger, ​ y propiedad de DC Comics. Apareció por primera vez en la historia titulada «El caso del sindicato químico» de la revista Detective Comics N.° 27, lanzada por la editorial National Publications el 30 de marzo de 1939.', '2022-07-28 14:57:14', 'imagenes/22914301.jpg'),
(4, 'Spiderman', 'emmanuel302001@gmail.com', 'Spider-Man, traducido en ocasiones como El Hombre Araña, ​​ es un personaje creado por los estadounidenses Stan Lee y Steve Ditko, ​​ e introducido en el cómic Amazing Fantasy n.° 15, publicado por Marvel Comics en agosto de 1962.​', '2022-07-28 18:10:07', 'imagenes/31601498876_582320_1601498920_noticia_normal.jpg');
...
ALTER TABLE `facturacion`
  ...
  ADD KEY `fk_facturacion_cliente_idx` (`id_tercero`),
  ADD KEY `comp_fact` (`fact_consecutivo`,`fact_prefijo`);
...
ALTER TABLE `facturacion_detalle`
  ...
  ADD KEY `fk_facturacion_detalle_facturacion1_idx` (`id_factura`);

--
-- Indices de la tabla `tblpost`
--
ALTER TABLE `tblpost`
...
ALTER TABLE `tercero`
  ...
  ADD UNIQUE KEY `documento_UNIQUE` (`documento`,`tipo_documento`);
...
--
ALTER TABLE `facturacion`
  MODIFY `id_factura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
-- AUTO_INCREMENT de la tabla `tblpost`
--
ALTER TABLE `tblpost`
...
--
ALTER TABLE `tercero`
  MODIFY `id_tercero` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
